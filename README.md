...
- **검색어 보정**: 정규화/별칭/재시도 기반 검색 품질 향상 (토글 가능)
...
- 검색창 아래의 **검색어 보정** 토글을 켜면 정규화/별칭/재시도 검색이 활성화됩니다.
- 별칭 파일은 사용자 데이터 디렉토리의 `user_data/avatar_aliases.json`에서 수정할 수 있습니다.
  - 기본 파일: `data/avatar_aliases.json`
